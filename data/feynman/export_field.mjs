 ...
 *
 *   node data/feynman/export_field.mjs                   # 1920x1080, seed 7
 *   node data/feynman/export_field.mjs --w 1080 --h 1920 # portrait
 *   node data/feynman/export_field.mjs --seed 12 --scale 2.8
 *   node data/feynman/export_field.mjs --all             # the whole shipped set
 *
 * The generator is not reimplemented in Python. network.js beside this file
 * is a copy of
...
const win = {};
new Function('window', readFileSync(resolve(HERE, 'network.js'), 'utf8'))(win);
const N = win.SMMNet;
